				...
				<div class="notice col-6">
					<table class="table">
						...
						%>
							<tr>
								...
								<td><a href="#"><%=list.get(i).getnTitle() %></a>
					...
					<div class="col-12 " >
						<nav>
						  ...
						  <%if(pageNum!=1){ %>
						 	<li class="page-item"><a class="page-link" href="notice.jsp?pageNum=<%=pageNum-1%>">이전</a></li>
						 	<%} 
						  NoticeDAO pageDAO = new NoticeDAO();
						  int pageCnt =pageDAO.page();
						 	for(int i=0; i<pageCnt;i++){
						 	%>
						    <li class="page-item "><a class="page-link" href="notice.jsp?pageNum=<%=i+1%>"><%=i+1%></a></li>
						   
						    <%} 
						    if(pageNum!=pageCnt){
						    %>
						 	<li class="page-item"><a class="page-link" href="notice.jsp?pageNum=<%=pageNum+1%>">다음</a></li>
						  	<%} %>
						  </ul>
						</nav>
					</div>
